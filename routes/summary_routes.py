...
# summarize_decision
###############################################################################
@summary_bp.route('/summarize_decision', methods=['POST', 'OPTIONS'])
def summarize_decision_route():
    ...
    try:
        ...
        print("Received /summarize_decision request.")

        # Call the summarize_decision function from helpers.decision_helper.py
        summary = str(summarize_decision(decision_text))
        assistant_prompt = "Please summarize the structured decision information in natural language."
